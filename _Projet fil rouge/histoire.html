		...
		<div class="row">
			<div class="col-md-12 zone"><center>
				<h1 id="color">Histoire:</h1>
					...
					<a href="enigme1.html"><button type="submit" class="btn btn-default">Tu es prêt ?</button></a><br><br>
					<!-- lancer une pop-up?-->
                    <a href="accueil.html"><button type="submit" class="btn btn-default">Tu as peur ?</button></a>
                    <!-- lancer une pop-up?-->
	</center></div>
