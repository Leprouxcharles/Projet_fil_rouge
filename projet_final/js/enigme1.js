    ...
    if (event.key = 'enter' && $('.azerty')[0].value == 'ARBRE') {
      ...
      $('.zone').append('<div class="modal-content">'+
                '<div class="modal-header">'+
                  '<h4 class="modal-title" style="color:black;">VICTOIRE !</h4>'+
                '</div>'+
                '<div class="modal-body">'+
                '<span style="color:black;">Votre score est :</span>'+
                  '<form action="php/updateEnigme2.php" method="post">' +
                    '<input style="color:black;" type="text" value="" name="scoreEnigme1" class="scoreInput">'+
                    '<br/>'+
